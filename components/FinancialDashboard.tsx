...
import { TrendingUp, Activity, Calendar, ArrowUpRight, ArrowDownRight, ChevronLeft, ChevronRight, Info, DollarSign, Target, PieChart, Clock, Loader2 as LoaderIcon } from 'lucide-react';
...
export const FinancialDashboard: React.FC<Props> = ({ manualTransactions = [], orgType = 'Startup' }) => {
    ...
    const StatCard = ({ title, value, isCurrency = true, delta, inverse = false, tooltip }: any) => {
        ...
        return (
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-white/5 flex flex-col justify-between h-40 hover:shadow-2xl transition-all group relative">
                {/* Camada de Clipping Isolada */}
