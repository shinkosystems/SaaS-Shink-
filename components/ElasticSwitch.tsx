...
export const ElasticSwitch: React.FC<Props> = ({ checked, onChange, id, disabled }) => (
  <button
    ...
    className={`
      ...
      transition-colors duration-300 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-shinko-primary focus-visible:ring-offset-2
      ${checked ? 'bg-shinko-primary' : 'bg-slate-300 dark:bg-slate-600'}
